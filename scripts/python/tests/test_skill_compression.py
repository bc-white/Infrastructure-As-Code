...
def generate_stopword() -> List[tuple]:
    ...
    return [("Python and Java", "Python Java"), ("Python", "Python")]
...
def generate_condense_skills() -> List[tuple]:
    ...
    return [
        ...
        (
            ["Java", "Javascript", "Javascripting", " "],
            ["Java", "Javascript"],
            ["Javascripting"],
        ),
        (
            ["Microsoft Windows Server", "Microsoft Windows Server 2003 R2"],
            ["Microsoft Windows Server"],
...
def test_condense_skills(generate_condense_skills) -> None:
    ...
    for skill in generate_condense_skills:
        condensed_skills, removed_skills = skill_compression.condense_skills(
            skill[0], 80
        )
...
def test_ingest_skills(generate_test_file):
    ...
    assert (
        skill_compression.ingest_skills(generate_test_file[0], STOPWORDS)
