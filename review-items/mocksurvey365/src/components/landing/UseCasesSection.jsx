...
import { userCasesData, booksData } from './UserCasesData.js';
...
const UseCasesSection = ({
  ...
  const [activeUserType, setActiveUserType] = useState('Marketers');
      ...
      <div className="py-24 md:py-32">
        <div className="max-w-6xl mx-auto px-4 mb-16">
          ...
          <div className="flex justify-center space-x-8 mb-10">
            {Object.keys(userCasesData).map(type => <button key={type} className={cn("relative pb-1", activeUserType === type ? "text-primary font-medium" : "text-muted-foreground hover:text-foreground transition-colors")} onClick={() => setActiveUserType(type)}>
                {type}
